# Agente de Abertura de Chamados (GLPI)

Esta pasta contém todo o código, scripts, configurações e documentação específicas do agente responsável pela abertura de chamados no GLPI via Copilot Studio.
